...
<div class="wdcb8sn ui-dialog-overlayer" style="background-color: rgba(0, 0, 0, 0.667);">
   <div class="ui-dialog-wrap" style={`${$screen > 622 ? `width: 560px; height: 595px; margin-top: -297.5px; margin-left: -280px; opacity: 1; transform: none;` : ""}`}>
         ...
         <div class="ui-tabs tabs-circle">
            <div class="tabs-scroll">
               <div class="tabs-navs">
                  ...
                  <button disabled on:click={()=>handleTabs(2)} class={`tabs-nav ${fiat ? "is-active" : "" }`}>Fiat</button>
                  <button disabled on:click={()=>handleTabs(3)} class={`tabs-nav ${buy ? "is-active" : "" }`}>Buy Crypto</button>
               </div>
            </div>
