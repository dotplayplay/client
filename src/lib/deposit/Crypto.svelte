    ...
    <div class="conqb7w">
        <div class="swm8knq">
            ...
            <div class="ui-select wallet-balance-input-wrap">
                <button  on:click={()=> handleCoinSelect()} class="select-trigger">
                    <img class="coin-icon" alt="" src="https://assets.coingecko.com/coins/images/325/large/Tether.png?1668148663">
...
.ui-select .ui-input .input-control {
    min-height: auto;
    background-color: #17181b;
}
.ui-input .input-control {
...
.ui-select .select-options .select-option {
    height: 3rem;
...
.c1uqqykw .amount-wrap .monospace {
    color:  #fff;
    font-weight: 800;
    line-height: 1;
    height: 1.375rem;
...
.c1uqqykw .amount-wrap .amount-info {
    display: -webkit-box;
    display: -webkit-flex;
    display: -ms-flexbox;
    display: flex;
...
.c1uqqykw .amount-wrap .coin {
    text-align: right;
}
.c1uqqykw .amount-wrap .weaken {
    height: 1.125rem;
    line-height: 1.125rem;
}
.c1uqqykw .amount-wrap .weaken .amount {
    color: rgba(153,164,176,.5);
    font-weight: 400;
    font-size: .75rem;
}
