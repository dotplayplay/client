...
import WiDayLightWind from "svelte-icons-pack/wi/WiDayLightWind";
            ...
            <div class="sc-gSQFLo dprxuS theme">
                <div class="theme-check">
                    ...
                    <button on:click={()=>handeTheme("light")} class={ `item ${isLight ? "is-active" : ""} `}>
                        <Icon  src={WiDayLightWind}  size="18"  color="#ffff" className="custom-icon" title="light" />
                    </button>
                </div>
